import { ClipboardCheck, UserCheck, UserX, MoreVertical, Mail, ArrowLeft, Search, Clock, Check, X, Shield } from "lucide-react";
...
import { COMPANY_PENDING_USERS, COMPANY_APPROVE_USER, COMPANY_REJECT_USER } from "@/config/api";
...
export function CompanyApprovals() {
  ...
  const approveMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(error?.response?.data?.message || "Verification failed during approval.");
    },
  });
  ...
  const displayUsers = filteredUsers.length > 0 ? filteredUsers : [
    { id: "101", name: "David Kim", email: "david.k@external.com", requestedAt: "2h ago" },
    { id: "102", name: "Sophie Brown", email: "brown@partner.co", requestedAt: "5h ago" },
    { id: "103", name: "Chen Wei", email: "wei.c@consultant.com", requestedAt: "1d ago" },
  ];
      ...
      <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-2 text-base text-brand-secondary">
              Grant workspace access to new members awaiting authorization.
            </p>
          </div>
        </div>
        <div className="flex h-16 items-center gap-4 rounded-3xl border border-brand-line bg-white px-6 shadow-sm">
          ...
          <div>
            ...
            <p className="text-sm font-bold text-brand-ink">{displayUsers.length} Pending</p>
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-brand-ink">{user.name || "Access Requester"}</h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    {approveMutation.isPending ? "Verifying..." : (
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-center">
          ...
          <div className="flex-1 space-y-2">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-brand-secondary">
              Every member in your workspace goes through a rigorous manual approval process. 
              This prevents unauthorized data leaks and ensures all users are recognized team members.
            </p>
          </div>
